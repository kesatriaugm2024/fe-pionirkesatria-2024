...
export default function Navbar() {
  ...
  const NavbarTablet = () => {
    return (
      <nav
        className={
          "fixed z-[999] flex w-full justify-between bg-gradient-to-r from-[#34144E] from-50% to-[#5E1675] px-[2vw] py-[1vw] font-publica-sans text-[2vw]/[2vw] text-[#FFE5C7] shadow-[0_0.6vw_10vw_0_#000000] duration-300 max-md:hidden lg:hidden"
        }
      >
        <div className="font- flex items-center gap-x-[0.5vw]">
          <Image
  ...
  const NavbarHP = () => {
    ...
    return (
      <nav
        className={
          "fixed z-[999] flex w-full flex-col bg-gradient-to-r from-[#34144E] from-50% to-[#5E1675] px-[2vw] py-[1vw] font-publica-sans text-[2vw]/[2vw] text-[#FFE5C7] shadow-[0_0.6vw_10vw_0_#000000] md:hidden"
        }
      >
