...
export function Filosofi_Desktop({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="flex h-[5vw] w-[38vw] flex-row items-center justify-center gap-[2vw] rounded-[1.5vw] bg-[#4C1F72]/40 p-[0.2vw] px-[3vw]">
        <Image
...
export function Filosofi_Tablet({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <div className="relative my-[1vw] flex h-[18vw] w-[24vw] items-center justify-center rounded-[1.5vw] bg-gradient-to-t from-[#FFB7A7] to-[#FFE5C7]">
        <Image
          src={"/images/filosofi/logo-kesat.png"}
          alt="Gamadhira"
          width={1000}
      ...
      <div className="flex h-[9vw] w-[70vw] flex-row items-center justify-center gap-[8vw] rounded-[1.5vw] bg-[#4C1F72]/40 p-[0.2vw] px-[3vw]">
        <Image
          src={"/images/filosofi/logo-1.png"}
          alt="Gamadhira"
          width={1000}
      ...
      {/* Gambar Gerigi */}
      <Image
        className="absolute -bottom-[40vw] -left-[20vw] z-[0] w-full scale-[0.2]"
        alt="Gamadhira"
...
export function Filosofi_Mobile({ className }: { className?: string }) {
  return (
    ...
    >
      <div className="z-10 flex w-full flex-col items-center justify-center">
        <h1 className="text-center font-legendaire text-[7vw]/[7vw] drop-shadow-[0_4px_5px_rgba(0,0,0,1)] gradient-text-yellow-up-down">
          Mengenal Pionir Kesatria
        </h1>
        <h2 className="text-center font-legendaire text-[9vw]/[9vw] drop-shadow-[0_4px_5px_rgba(0,0,0,1)] gradient-text-yellow-up-down">
          Gamadhira
        </h2>
      </div>
      <div className="relative my-[1vw] flex h-[24vw] w-[32vw] items-center justify-center rounded-[1.5vw] bg-gradient-to-t from-[#FFB7A7] to-[#FFE5C7]">
        <Image
          src={"/images/filosofi/logo-kesat.png"}
          alt="Gamadhira"
          width={1000}
      ...
      <div className="-my-[1vw] flex h-[14vw] w-[44vw] flex-row items-center justify-center gap-[8vw] rounded-[1.5vw] bg-[#4C1F72]/40 p-[0.2vw] px-[3vw]">
        <Image
          src={"/images/filosofi/logo-1.png"}
          alt="Gamadhira"
          width={1000}
      ...
      <div className="flex h-[14vw] w-[60vw] flex-row items-center justify-center gap-[8vw] rounded-[1.5vw] bg-[#4C1F72]/40 p-[0.2vw] px-[3vw]">
        <Image
          src={"/images/filosofi/logo-3.png"}
          alt="Gamadhira"
          width={1000}
      ...
      {/* Gambar Gerigi */}
      <Image
        className="absolute -left-[17vw] -top-[40vw] z-[0] w-full scale-[0.25]"
        alt="Gamadhira"
        src="/images/filosofi/tablet/gerigi-kuning.svg"
        width={1000}
        height={1000}
