...
export const ItemPertanyaan = ({
  ...
  return (
    <div
      className={`flex w-[80vw] cursor-pointer flex-col items-start rounded-[1.5vw] bg-gradient-to-r from-[#B22635] to-[#EA5571] duration-200 sm:w-[90vw] lg:w-[80vw] ${
        isOpen ? "h-[6vw]" : "h-[3vw]"
      }`}
      onClick={handleClick}
    >
      <div className="flex w-full items-center justify-between rounded-[1.5vw] bg-gradient-to-b from-[#FFA514] to-[#FFD23F] pr-[1.5vw] sm:h-[6vw] lg:h-[3vw]">
        <p className="px-[1vw] font-publica-sans font-medium text-[#5E1675] sm:text-[1.6vw] lg:text-[1.4vw]">
          {question}
        </p>
        <div className="mr-[1vw] h-[1.25vw] w-[1.25vw] items-end">
