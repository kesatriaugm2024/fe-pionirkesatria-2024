...
function DepartemenCardDesktop({
  ...
  return (
    <div className="flex flex-col place-content-center items-center gap-[4vw] px-[10vw] lg:gap-0 lg:py-[5vw]">
      ...
      <div className="flex h-[30vw] w-[60vw] items-center justify-between max-lg:h-[50vw]">
        {prodi.map((item: any, idx: number) => (
          <Link
            ...
            key={idx}
          >
            <div className="z-[1] h-[23vw] w-[13vw] flex-shrink-0 rounded-[1.7vw] border-[0.2vw] bg-gradient-to-b from-[#FFD23F] to-[#FFA514] duration-100 hover:h-[27.8vw] hover:w-[15.6vw] max-lg:h-[40vw] max-lg:w-[20vw] max-lg:hover:h-[50vw] max-lg:hover:w-[25vw]">
              <Image
